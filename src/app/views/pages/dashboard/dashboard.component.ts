...
products:any;
  ...
  constructor(private calendar: NgbCalendar,  private clientservice: ClientService,
  ...
  Getclients() {
    this.clientservice.getClientsData().subscribe((res) => {
      this.clients = res;
      this.Nbrcl=this.clients.length;
    });
  }
  ...
  GetProducts() {
    this.productservice.getProductsData().subscribe((res) => {
      this.products = res;
      this.Nbrprod=this.products.length;
    });
  }
  ...
  Getcategories() {
    this.categorieservice.getCategoryData().subscribe((res) => {
      this.Categories = res;
      this.Nbrcat=this.Categories.length;
    });
  }
